...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "entranceTitle1": MessageLookupByLibrary.simpleMessage(
      "Si aquest colom tan bufó no t\'ajuda a votar al juny, res no ho farà.",
    ),
    ...
    "entranceTitle2": MessageLookupByLibrary.simpleMessage(
      "Fes lliscar el dit per donar la teva opinió sobre els temes que t\'importen.",
    ),
    ...
    "entranceTitle3": MessageLookupByLibrary.simpleMessage(
      "Descobreix amb qui has fet match i obtén una orientació sobre qui votar a les eleccions.",
    ),
    ...
    "languagePageSubtitle": MessageLookupByLibrary.simpleMessage(
      "Pots canviar-ho més endavant des de la pàgina de configuració.",
    ),
    ...
    "onBoardingStep1Subtitle": MessageLookupByLibrary.simpleMessage("No ho sé"),
    "onBoardingStep1Title": MessageLookupByLibrary.simpleMessage("On votaràs?"),
    ...
    "onBoardingStep3Option4": MessageLookupByLibrary.simpleMessage("No binari"),
    "onBoardingStep3Option5": MessageLookupByLibrary.simpleMessage("Altres"),
    ...
    "resultsPage10YesButton": MessageLookupByLibrary.simpleMessage("Síííííí"),
    ...
    "resultsPage2_1Title": MessageLookupByLibrary.simpleMessage("Mira, entre"),
    ...
    "resultsPage4TitleBottom": MessageLookupByLibrary.simpleMessage(
      "Antiintegració de la UE",
    ),
    "resultsPage4TitleBottom_ger25": MessageLookupByLibrary.simpleMessage(
      "Socially conservative",
    ),
    "resultsPage4TitleLeft": MessageLookupByLibrary.simpleMessage("Esquerra"),
    ...
    "resultsPage6Text": MessageLookupByLibrary.simpleMessage(
      "A les pantalles següents descobriràs les candidatures locals al teu país que més probablement s\'uniran al teu match.",
    ),
    ...
    "resultsPage6_1Title": MessageLookupByLibrary.simpleMessage(
      "Entesos, està guai saber amb quin grup encaixo més...",
    ),
    ...
    "resultsPage6_2Title": MessageLookupByLibrary.simpleMessage(
      "Però a les eleccions europees, votem a candidatures locals",
    ),
    ...
    "settingsPageTitlePartners": MessageLookupByLibrary.simpleMessage("Socis"),
